...
const APIIntegration = () => {
      ...
      <CardContent>
        <Tabs defaultValue="rest" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            <Tab value="rest">REST APIs</Tab>
            <Tab value="graphql">GraphQL</Tab>
            <Tab value="webhook">Webhooks</Tab>
          </TabsList>
          
          <TabPanel value="rest" className="mt-4 space-y-4">
          ...
          <TabPanel value="graphql" className="mt-4">
  ...
  repository(name: "example") {
    ...
    description
          ...
          <TabPanel value="webhook" className="mt-4">
            <div className="space-y-4">
              ...
              <div className="rounded-md bg-muted p-4">
                <p className="text-sm font-mono">
                  https://nexus-platform.ai/api/webhooks/callback/12345
                </p>
